            ...
            <div id="account" role="tabpanel">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Détail Personnel</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
								        ...
								        <textarea rows="2" class="form-control" id="inputBio" placeholder="Tell something about yourself" style="height: 52px;"></textarea>
							        </div>
                                </div>
                                <div class="col-md-4">
